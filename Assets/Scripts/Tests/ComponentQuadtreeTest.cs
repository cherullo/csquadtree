...
public class ComponentQuadtreeTest : PointTest
{
    private ComponentQuadtree<Component> m_tree;
    private int m_pass = 0;

    void Start()
    {
        m_tree = new ComponentQuadtree<Component>(0.0f, 0.0f, m_sideLength, m_sideLength);
    }
