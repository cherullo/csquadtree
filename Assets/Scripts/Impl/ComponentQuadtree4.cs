...
public class ComponentQuadtree4<T> : ComponentQuadtreeNode<T>, IRebuildableQuadtree<T> where T : Component
{
    private SearchData<T> m_searchData = new SearchData<T>();

    public ComponentQuadtree4 (float p_bottomLeftX, float p_bottomLeftY, float p_topRightX, float p_topRightY) : base (null, p_bottomLeftX, p_bottomLeftY, p_topRightX, p_topRightY)
    {
        m_parent = null;
    }
...
//            return;
    ...
    private void CreateChildNodes()
    {
        ...
        m_nodes [0]                 = new ComponentQuadtreeNode<T> (this, m_bottomLeftX, m_bottomLeftY, m_centerX, m_centerY);
        m_nodes [K_RIGHT]           = new ComponentQuadtreeNode<T> (this, m_centerX, m_bottomLeftY, m_topRightX, m_centerY);
        m_nodes [K_TOP]             = new ComponentQuadtreeNode<T> (this, m_bottomLeftX, m_centerY, m_centerX, m_topRightY);
        m_nodes [K_RIGHT + K_TOP]   = new ComponentQuadtreeNode<T> (this, m_centerX, m_centerY, m_topRightX, m_topRightY);
    }
